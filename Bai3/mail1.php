...
use PHPMailer\PHPMailer\Exception;
          ...
          $mail = new PHPMailer(true);  //true: enables exceptions
		    ...
		    $nguoigui = 'Nguyenngotramy2427@gmail.com';
		    $matkhau = ' oxlf grzp agty bmqo';// mật khẩu của tài khoản ngolequanvh@gmail.com
		    $tennguoigui = 'Nhập tên người gửi';
                ...
                // $to = "mynnt.22ds@vku.udn.vn";
                $to_name = "heloo";
                
 //mail và tên người nhận
                // $mail->addAddress("nlquan@vku.udn.vn","lequan");
                 $recipients = "mynnt.22ds@vku.udn.vn,nhinth.22ds@vku.udn.vn,quyntm.22ds@vku.udn.vn";
